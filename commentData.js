...
//NOTE: the array titled "comments" has 3 elements in object types.
//to access the comment of the first object via dot notation:
//comments[0].comment;
//to access the username of the third object via dot notation:
//comments[2].username;
